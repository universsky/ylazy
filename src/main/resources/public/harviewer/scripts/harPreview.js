...
define("core/lib", ["core/trace"], function (e) {
    ...
    return u.prototype = {
        ...
        run: function (t, n) {
            ...
            r && r[r.length - 1] != "/" && (r += "/");
            var i = e.getURLParameters("path"), s = e.getURLParameter("callback"), o = e.getURLParameters("inputUrl").concat(e.getHashParameters("inputUrl")), u = [];
    ...
    with (Domplate) {
        ...
        var MenuPlate = domplate({
            tag: DIV({"class": "menu", _repObject: "$object"}, DIV({
            ...
            }), DIV({"class": "menuContent", style: "display: none"})), onMouseMove: function (e) {
                var t = Lib.fixEvent(e);
                this.open(t.target)
                ...
                var t = Lib.getAncestorByClass(e, "menu"), n = Lib.getElementByClass(t, "menuContent");
                if (n.clientWidth > 0)return;
                this.toggle(e)
            }, toggle: function (e) {
                var t = Lib.getAncestorByClass(e, "menu"), n = Lib.getElementByClass(t, "menuContent");
                $(n).animate({width: "toggle"}, undefined, undefined, function () {
                    var e = Lib.getElementByClass(t, "menuHandle");
                    n.clientWidth > 0 ? Lib.setClass(e, "opened") : Lib.removeClass(e, "opened")
                })
            }, render: function (e, t) {
                return this.tag.append({object: t}, e, this)
            }
        });
        return Menu
    }
    ...
    u.prototype = {
        initialize: function (e) {
            ...
            var t = r.bind(this.appendPreview, this), i = r.bind(this.onError, this);
            n.Loader.run(t, i)
        }, appendPreview: function (e) {
            try {
                var s = !0, u = r.getURLParameter("validate");
                u == "false" && (s = !1);
                var f = n.parse(e, s);
                this.model.append(f);
                var l = new t(f);
    ...
    var a = document.getElementById("content"), f = a.repObject = new u;
